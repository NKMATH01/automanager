 ...
 *
 * Plugin bundles are built with `external: ["@automanager/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@automanager/plugin-sdk/ui";
 ...
 * - `import { ... } from "@automanager/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@automanager/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@automanager/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@automanager/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@automanager/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@automanager/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
