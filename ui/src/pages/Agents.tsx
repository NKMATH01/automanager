...
import { AGENT_ROLE_LABELS, type Agent } from "@automanager/shared";
...
export function Agents() {
  ...
  return (
    <div className="space-y-4">
      ...
      {filtered.length > 0 && (
        <p className="text-xs text-muted-foreground">{filtered.length}개의 에이전트</p>
      )}
      ...
      {agents && agents.length === 0 && (
        <EmptyState
          icon={Bot}
          message="시작하려면 첫 번째 에이전트를 생성하세요."
          action="새 에이전트"
