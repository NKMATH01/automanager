...
export function CliAuthPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          <h1 className="text-lg font-semibold">CLI 인증 챌린지 사용 불가</h1>
  ...
  if (challenge.status === "approved") {
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          <h1 className="text-xl font-semibold">CLI 접근 승인됨</h1>
          <p className="mt-2 text-sm text-muted-foreground">
      ...
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          <h1 className="text-xl font-semibold">
            {challenge.status === "expired" ? "CLI 인증 챌린지 만료" : "CLI 인증 챌린지 취소됨"}
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
      ...
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <div className="mt-5 space-y-3 text-sm">
          ...
          <div>
            ...
            <div className="text-foreground">{challenge.clientName ?? "automanager cli"}</div>
          </div>
          <div>
