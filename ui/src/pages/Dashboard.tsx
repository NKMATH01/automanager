...
import type { Agent, Issue } from "@automanager/shared";
    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message="오토매니저에 오신 것을 환영합니다. 첫 번째 회사와 에이전트를 설정하세요."
          action="시작하기"
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {data.budgets.activeIncidents}건의 활성 예산 인시던트
                  </p>
                  <p className="text-xs text-red-100/70">
                    에이전트 {data.budgets.pausedAgents}개 일시정지 · 프로젝트 {data.budgets.pausedProjects}개 일시정지 · 대기 중 예산 승인 {data.budgets.pendingApprovals}건
                  </p>
                </div>
              </div>
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? `${data.budgets.pendingApprovals}건의 예산 초과 승인 대기 중`
                    : "이사회 검토 대기 중"}
                </span>
              }
            />
