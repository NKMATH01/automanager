...
export function CompanySettings() {
  ...
  const inviteMutation = useMutation({
    ...
    onError: (err) => {
      setInviteError(
        err instanceof Error ? err.message : "초대 생성 실패"
      );
    }
  });
    ...
    <div className="max-w-2xl space-y-6">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  {logoUrl && (
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {clearLogoMutation.isPending ? "제거 중..." : "로고 제거"}
                      </Button>
                    </div>
                  )}
              ...
              <Field
                label="브랜드 색상"
                hint="회사 아이콘의 색조를 설정합니다. 자동 생성 색상을 사용하려면 비워두세요."
              >
                <div className="flex items-center gap-2">
                  <input
                    type="color"
      ...
      {generalDirty && (
        <div className="flex items-center gap-2">
          ...
          >
            {generalMutation.isPending ? "저장 중..." : "변경사항 저장"}
          </Button>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            가져오기와 내보내기가 {" "}
            <a href="/org" className="underline hover:text-foreground">조직도</a> 헤더에서 접근 가능한 전용 페이지로 이동했습니다.
          </p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-destructive/40 bg-destructive/5 px-4 py-4">
          <p className="text-sm text-muted-foreground">
            이 회사를 보관하여 사이드바에서 숨깁니다. 데이터베이스에
            유지됩니다.
          </p>
          <div className="flex items-center gap-2">
            <Button
...
- run: pnpm automanager allowed-hostname <host>
- restart Paperclip
