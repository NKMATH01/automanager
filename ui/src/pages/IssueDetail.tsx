...
import type { ActivityEvent } from "@automanager/shared";
import type { Agent, Issue, IssueAttachment, IssueComment } from "@automanager/shared";
...
const ACTION_LABELS: Record<string, string> = {
  "issue.created": "이슈 생성",
  "issue.updated": "이슈 수정",
  "issue.checked_out": "이슈 체크아웃",
  "issue.released": "이슈 해제",
  "issue.comment_added": "댓글 작성",
  "issue.attachment_added": "첨부파일 추가",
  ...
  "agent.updated": "에이전트 수정",
  "agent.paused": "에이전트 일시정지",
  "agent.resumed": "에이전트 재개",
  "agent.terminated": "에이전트 종료",
