...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@automanager/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@automanager/adapter-utils").TranscriptEntry[];
