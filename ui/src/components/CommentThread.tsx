...
import type { IssueComment, Agent } from "@automanager/shared";
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between gap-2">
            ...
            {onInterruptQueued && queuedComments[0]?.queueTargetRunId ? (
              ...
              >
                {interruptingQueuedRunId === queuedComments[0].queueTargetRunId ? "Interrupting..." : "중단"}
              </Button>
            ) : null}
          </div>
          <div className="space-y-3">
