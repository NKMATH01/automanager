...
import { PROJECT_COLORS } from "@automanager/shared";
        ...
        <div className="px-4 pt-3 pb-3 space-y-3 border-t border-border">
          <div>
            <div className="mb-1 flex items-center gap-1.5">
              <label className="block text-xs text-muted-foreground">저장소 URL</label>
              ...
              <Tooltip delayDuration={300}>
                ...
                <TooltipContent side="top" className="max-w-[240px] text-xs">
                  GitHub 저장소를 연결하면 에이전트가 이 프로젝트의 코드를 클론, 읽기, 푸시할 수 있습니다.
                </TooltipContent>
              </Tooltip>
            </div>
            <input
          ...
          <div>
            <div className="mb-1 flex items-center gap-1.5">
              <label className="block text-xs text-muted-foreground">로컬 폴더</label>
              <span className="text-xs text-muted-foreground/50">선택사항</span>
              <Tooltip delayDuration={300}>
                <TooltipTrigger asChild>
                  <HelpCircle className="h-3 w-3 text-muted-foreground/50 cursor-help" />
                ...
                <TooltipContent side="top" className="max-w-[240px] text-xs">
                  이 컴퓨터에서 로컬 에이전트가 이 프로젝트의 파일을 읽고 쓸 절대 경로를 설정하세요.
                </TooltipContent>
              </Tooltip>
            </div>
