...
import { AGENT_ADAPTER_TYPES } from "@automanager/shared";
import type {
  Agent,
...
// Canonical type lives in @automanager/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@automanager/adapter-utils";
import type { CreateConfigValues } from "@automanager/adapter-utils";
        ...
        <div className={cn(!cards && "border-b border-border")}>
          ...
          <div className={cn(cards ? "border border-border rounded-lg overflow-hidden" : "")}>
            ...
            <div className="space-y-3">
              ...
              <Field label="최대 동시 실행" hint={help.maxConcurrentRuns}>
                <DraftNumberInput
                  value={eff(
                    "heartbeat",
                    "maxConcurrentRuns",
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        AUTOMANAGER_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
        ...
        <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-1" align="start">
          <div className="relative mb-1">
            <input
              ...
              placeholder={creatable ? "Search models... (type to create)" : "모델 검색..."}
              value={modelSearch}
