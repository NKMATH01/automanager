/**
 * `@automanager/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@automanager/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@automanager/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@automanager/plugin-sdk/ui";
 *
