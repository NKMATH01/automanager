 ...
 * from `@automanager/plugin-sdk`.  The host provides a concrete implementation
...
// ---------------------------------------------------------------------------
// Re-exports from @automanager/shared (plugin authors import from one place)
// ---------------------------------------------------------------------------
 ...
 * ```
 *
 * @see usePluginStream in `@automanager/plugin-sdk/ui`
 */
 ...
 * @example
 * ```ts
 * import { definePlugin } from "@automanager/plugin-sdk";
 *
