...
import type { PaperclipPluginManifestV1 } from "@automanager/shared";
 ...
 * import { startWorkerRpcHost } from "@automanager/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@automanager/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
