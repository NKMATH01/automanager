...
Environment overrides:
  ...
  AUTOMANAGER_HOST=127.0.0.1    Host passed to the onboarded server
  AUTOMANAGER_PORT=3232         Port passed to the onboarded server
...
export AUTOMANAGER_HOST="${AUTOMANAGER_HOST:-127.0.0.1}"
export AUTOMANAGER_PORT="${AUTOMANAGER_PORT:-3100}"
export AUTOMANAGER_OPEN_ON_LISTEN="${AUTOMANAGER_OPEN_ON_LISTEN:-false}"
...
echo "AUTOMANAGER_HOST: $AUTOMANAGER_HOST"
echo "AUTOMANAGER_PORT: $AUTOMANAGER_PORT"
...
env \
  ...
  HOST="$AUTOMANAGER_HOST" \
  PORT="$AUTOMANAGER_PORT" \
  AUTOMANAGER_OPEN_ON_LISTEN="$AUTOMANAGER_OPEN_ON_LISTEN" \
  pnpm automanager onboard --yes --data-dir "$PC_DATA"
