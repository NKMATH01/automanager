...
const AUTOMANAGER_EMAIL = "noreply@paperclip.ing";
const AUTOMANAGER_NAME = "paperclip";
...
function normalizeContributor(input: {
  ...
  if ((email && email === AUTOMANAGER_EMAIL) || (displayName && displayName.toLowerCase() === AUTOMANAGER_NAME)) {
    return null;
  }
