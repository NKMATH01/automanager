...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@automanager/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@automanager/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@automanager/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@automanager/plugin-hello-world-example",
  ...
  {
    packageName: "@automanager/plugin-file-browser-example",
  ...
  {
    packageName: "@automanager/plugin-kitchen-sink-example",
  ...
  {
    packageName: "@automanager/plugin-supabase-readonly-example",
    pluginKey: "automanager.supabase-readonly-example",
    displayName: "Supabase Read-Only Connector",
    description: "Bundled connector that lets main agents inspect configured Supabase databases while limiting sub-agents to explicitly shared databases with read-only queries only.",
    localPath: "packages/plugins/examples/plugin-supabase-readonly-example",
    tag: "example",
  },
];
