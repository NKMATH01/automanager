...
import { agents as agentsTable, companies, heartbeatRuns } from "@automanager/db";
...
import { runClaudeLogin } from "@automanager/adapter-claude-local/server";
import {
...
import { ensureOpenCodeModelConfiguredAndAvailable } from "@automanager/adapter-opencode-local/server";
import {
...
export function agentRoutes(db: Db) {
  ...
  const strictSecretsMode = process.env.AUTOMANAGER_SECRETS_STRICT_MODE === "true";
