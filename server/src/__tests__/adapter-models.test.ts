...
import { models as codexFallbackModels } from "@automanager/adapter-codex-local";
import { models as cursorFallbackModels } from "@automanager/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@automanager/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@automanager/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.AUTOMANAGER_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.AUTOMANAGER_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
