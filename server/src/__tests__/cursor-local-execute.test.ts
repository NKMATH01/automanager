...
import { execute } from "@automanager/adapter-cursor-local/server";
...
describe("cursor execute", () => {
  it("injects paperclip env vars and prompt note by default", async () => {
    ...
    try {
      ...
      expect(capture.prompt).toContain("AUTOMANAGER_API_KEY");
      expect(invocationPrompt).toContain("Paperclip runtime note:");
      expect(invocationPrompt).toContain("AUTOMANAGER_API_URL");
    } finally {
