...
describe("agent local JWT", () => {
  const secretEnv = "AUTOMANAGER_AGENT_JWT_SECRET";
  const ttlEnv = "AUTOMANAGER_AGENT_JWT_TTL_SECONDS";
  const issuerEnv = "AUTOMANAGER_AGENT_JWT_ISSUER";
  const audienceEnv = "AUTOMANAGER_AGENT_JWT_AUDIENCE";
