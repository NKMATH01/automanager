...
import { companySecrets, companySecretVersions } from "@automanager/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@automanager/shared";
import { envBindingSchema } from "@automanager/shared";
