...
import { companySkills } from "@automanager/db";
import { readPaperclipSkillSyncPreference, writePaperclipSkillSyncPreference } from "@automanager/adapter-utils/server-utils";
import type { PaperclipSkillEntry } from "@automanager/adapter-utils/server-utils";
import type {
  CompanySkill,
...
import { normalizeAgentUrlKey } from "@automanager/shared";
import { findServerAdapter } from "../adapters/index.js";
import { resolveAutomanagerInstanceRoot } from "../home-paths.js";
...
function buildSkillRuntimeName(key: string, slug: string) {
  if (key.startsWith("automanager/paperclip/")) return slug;
...
function resolveManagedSkillsRoot(companyId: string) {
  return path.resolve(resolveAutomanagerInstanceRoot(), "skills", companyId);
}
