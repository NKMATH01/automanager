...
import type { BillingType, ExecutionWorkspace, ExecutionWorkspaceConfig } from "@automanager/shared";
import {
  agents,
  agentRuntimeState,
  agentTaskSessions,
    ...
    try {
      ...
      if (adapter.supportsLocalAgentJwt && !authToken) {
        logger.warn(
          ...
          "local agent jwt secret missing or invalid; running without injected AUTOMANAGER_API_KEY",
        );
      }
