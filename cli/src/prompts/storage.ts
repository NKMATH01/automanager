...
import { resolveDefaultStorageDir, resolveAutomanagerInstanceId } from "../config/home.js";
...
export async function promptStorage(current?: StorageConfig): Promise<StorageConfig> {
  ...
  const endpoint = await p.text({
    message: "S3 엔드포인트 (호환 백엔드의 경우 선택사항)",
